...
@Builder
@Entity
@Table(name = "tbl_bon_de_livraison_detail")
public class BonDeLivraisonDetailEntity implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JsonIgnore
    @JoinColumn(name = "id_bon_de_livraison", referencedColumnName = "id", insertable = false, updatable = false, nullable = false)
    private BonDeLivraisonEntity bonDeLivraison;
